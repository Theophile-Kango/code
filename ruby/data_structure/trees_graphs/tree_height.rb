def tree_height(tree_as_list)
  ...
  left_child_index = tree_as_list[2*i + 1].nil? ? nil : heights.length - i - 1 #index of left child's height in heights
  left_child_height = left_child_index.nil? ? 0 : heights[left_child_index] 
  
  # 4 Find height of right child
  right_child_index = tree_as_list[2*i + 2].nil? ? nil : left_child_index - 1 #index of right child's height in heights
